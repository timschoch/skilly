...
- Offered the git-shortcuts Slack summary after a merge in this repo → rule added to CLAUDE.md (No Slack): skilly never gets Slack posts; skip that step without asking.
