---
name: payload-admin-components
description: Use when building or customizing Payload CMS Admin Panel components. Covers component types (Root, Collection, Global, Field), Server vs Client components, hooks, styling, performance, and troubleshooting.
---
...
```tsx
// In Admin Panel UI: import from @payloadcms/ui
'use client'
import { Button } from '@payloadcms/ui'

// In frontend code: use specific paths for tree-shaking
