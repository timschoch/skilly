---
name: skilly-cli
description: Manage this repo's agent skills with the skilly CLI — add or remove bundles/skills, pull hub updates. Use when the user wants skills or bundles added, removed, or updated. Not for repo bootstrap (that is `skilly setup`, run once).
---

# Skilly CLI

This repo's skills are managed by skilly, a hub at `timschoch/skilly`. Always use the CLI; never install skills any other way (`skills add`, manual copies).
