#!/usr/bin/env bash
# Gate check `conventional-commits` (docs/spec-v1.md): the last 20 commits on
# the default branch match the conventional-commit pattern; merges skipped.
